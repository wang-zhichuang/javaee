...
<body>  
<form action="${basePath}/studentServlet?action=update" method="post">
    <input type="hidden" name="student_id" value="${student.id}"/>

    学号:<input  name="student_no" value="${student.sno}"/><br>
    学生名称:<input  name="student_name" value="${student.sname}"/><br>
